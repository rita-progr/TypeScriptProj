...
import {ArticleSortType, ArticleType, ArticleViews} from "entities/Article";
...
export const getArticlesPageSort = (state: StateSchema) => state?.articlesPage?.sort ?? ArticleSortType.CREATED;
